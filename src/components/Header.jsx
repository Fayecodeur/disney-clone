    ...
    <div className="flex items-center justify-between p-4">
      <div className="flex items-center gap-4">
        ...
        <div className="md:hidden relative " onClick={handleMenu}>
          ...
          {menuOpen ? (
            <div className="z-[100] absolute mt-3 bg-[#060a12] border border-gray-700 px-6 py-3 flex flex-col gap-2 rounded-md ">
              {menu.map(
                (item, index) =>
                  index >= 3 && (
                    <HeaderItems
      ...
      <div>
        <img
          ...
          src="https://images.unsplash.com/photo-1634926878768-2a5b3c42f139?q=80&w=1356&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="User image"
        />
      </div>
    </div>
