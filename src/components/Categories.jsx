...
export default function Categories() {
  ...
  return (
    <section className="flex items-center gap-5 px-5 md:px-16  p-2 overflow-hidden relative">
      {ListCategories.map((item) => (
        <article
          key={item.id}
          className="bg-transparent border-[2px] border-gray-200 rounded-md cursor-pointer hover:scale-110 transition-all shadow-xl shadow-black"
        >
          <video
